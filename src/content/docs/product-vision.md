...
3. **Who do we build for?** — The personas whose lives we're trying to change. See [Three Personas](/productos-site/guides/personas/) for how to define yours.
...
|---|---|
| [Decision Framework](/productos-site/guides/decision-framework/) (Signal → Standard → Speed) | "Signal" tests whether an idea aligns with the vision. No alignment = no signal, regardless of how good the idea sounds. |
| [Product Principles](/productos-site/guides/product-principles/) | Principles are how the vision becomes engineering and design standards. They are the vision applied at the level of individual decisions. |
| [Invariants](/productos-site/guides/invariants/) | The third anchor. The vision *names* the lines you won't cross; the Invariants doc *owns* and enforces them. They are the kill-clause in the verdict rule. |
...
| [RICE](/productos-site/guides/rice/) | Reach and Impact are scored relative to the personas and metric the vision identifies. |
| [Post-Launch Review](/productos-site/templates/post-launch-review/) | The headline metric from the vision is the long-arc number reviewed at 60–90 days. |
| [Roadmap](/productos-site/product-playbook/#phase-3-shape) | Three-band roadmap is organised around the vision's themes, not features. |
...
- [ ] **Out of scope listed** — At least three things you are *not* doing. Specific, not aspirational ("we don't do X" not "we focus on Y"). The strongest of these — the lines you won't cross *by construction* — graduate to named [invariants](/productos-site/guides/invariants/).
...
Most products have a *creator* persona, a *consumer* persona, and a *sponsor* persona — the person who *configures* the product, the person who *uses it day to day*, and the person who *pays for it or is accountable for the outcome*. The names change; the structure rarely does. See [Three Personas](/productos-site/guides/personas/) for the canonical structure.
...
1. your invariants doc (if the lines you won't cross changed)
...
- **[Product Playbook](/productos-site/product-playbook/)** — How the six phases use this vision as the spine of every decision.
- **[Decision Framework](/productos-site/guides/decision-framework/)** — Signal → Standard → Speed; the operational check against the vision.
- **[Three Personas](/productos-site/guides/personas/)** — Canonical structure for the persona section above.
- **[Product Principles](/productos-site/guides/product-principles/)** — Turning the vision into engineering standards (the second anchor).
- **[Invariants](/productos-site/guides/invariants/)** — The lines you won't cross by construction (the third anchor); the vision names them, this doc owns them.
