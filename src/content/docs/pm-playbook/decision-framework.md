...
Does the proposed approach pass each of your [product principles](/productos-site/anchors/product-principles/)? Run the check questions for each principle against the proposed solution.
...
### Vision Check
How does this move the headline metric from the [product vision](/productos-site/anchors/product-vision/)?
```
