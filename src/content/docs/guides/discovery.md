...
**How:**
- Use the [Customer Call Template](/productos-site/templates/customer-call/)
...
**Output:** Competitive summary table in research doc (see [Research Template](/productos-site/templates/research/))
...
|--------|-------------|----------|
| **Research doc** | Every discovery effort — link in your RFC Evidence section | [Research Template](/productos-site/templates/research/) |
...
- **[Handling Product Feedback](/productos-site/guides/customer-feedback/)** — How feedback enters the system
- **[RFC guide](/productos-site/guides/product-specs/)** — Where discovery evidence lands
- **[Delivery Standards](/productos-site/guides/delivery-standards/)** — Where discovery fits in the delivery process
