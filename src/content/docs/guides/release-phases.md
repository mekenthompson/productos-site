...
**stakes / [path](/productos-site/guides/decision-framework/)**, which drive *how much GTM
...
- **After GA:** maintain the flag for a stabilisation window; run the
  [post-launch reviews](/productos-site/guides/delivery-standards/#post-ship-reviews) at 2 weeks /
...
Gates](/productos-site/guides/delivery-standards/#gates-and-approvals).
...
- [Delivery Standards](/productos-site/guides/delivery-standards/) — the full lifecycle and gates
...
- [Post-Launch Review](/productos-site/templates/post-launch-review/) — the reviews that
  run after GA.
